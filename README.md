...
- Web scaffold now includes saved-profile loading, a 7-day planner grid (breakfast/lunch/dinner) with drag-and-drop meal reorganization, and categorized shopping totals with JSON export.
