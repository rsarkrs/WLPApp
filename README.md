...
The purpose for this repo is to practice leveraging a wide variety of Gen AI tools and therefore all code within this project was generated by an initial prompt and back-and-forth conversations in Codex. Constraint-based meal planning application focused on metabolic safety, macro adherence, household scaling, and unified shopping output.
